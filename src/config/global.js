  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        ...
        numero: '1',
        titulo:
          'Planeación: definición de objetivos, estrategias y planes de acción',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
            numero: '1.1',
            titulo: 'Definición de la planeación',
            hash: 't_1_1',
          },
          {
            icono: 'far fa-file-alt',
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '1.3',
            titulo: 'Establecimiento de objetivos organizacionales',
            hash: 't_1_3',
          },
          {
            icono: 'far fa-file-alt',
      ...
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '3',
        titulo: 'Dirección y control: liderazgo, motivación y supervisión',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
            numero: '3.1',
            titulo: 'Concepto de dirección',
            hash: 't_3_1',
          },
          {
            icono: 'far fa-file-alt',
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '3.4',
            titulo: 'Funciones de la dirección',
            hash: 't_3_4',
          },
          {
            icono: 'far fa-file-alt',
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '3.6',
            titulo: 'Herramientas y fases del control',
            hash: 't_3_6',
          },
        ],
      },
